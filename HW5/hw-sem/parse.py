#!/Users/xiaomangguo/miniforge3/envs/nlp-class/bin/python
"""
...
class Agenda:
    ...
    def requeue(self, item: Item) -> None:
        """finding item with smaller weights, mark it as reprocessing"""
        idx = self._index[item]             
        self._redo.append(idx)             
